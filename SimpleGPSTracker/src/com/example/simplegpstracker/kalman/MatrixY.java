...
public class MatrixY {
	...
	public MatrixY(int rows, int cols) {
		mRows = rows;
		mCols = cols;
		mData = new double[mRows * mCols];
	}
	
	public MatrixY(MatrixY other) {
		mRows = other.mRows;
		mCols = other.mCols;
		mData = new double[mRows * mCols];
	 ...
	 */
	public static void add(MatrixY a, MatrixY b, MatrixY c) {
	 ...
	 * @p a and @p b remain unchanged.
	 */
	public static void subtract(MatrixY a, MatrixY b, MatrixY c) {
		assert a.mData.length == b.mData.length;
		assert a.mData.length == c.mData.length;		
		for (int i = 0; i < a.mData.length; ++i) {
			c.mData[i] = a.mData[i] - b.mData[i];
	 ...
	 * @p a and @p b remain unchanged.
	 */
	public static void multiply(MatrixY a, MatrixY b, MatrixY c) {
	 ...
	 * @p a and @p b remain unchanged.
	 */
	public final static void multiplyByTransposeMatrix(MatrixY a, MatrixY b, MatrixY c) {
	 ...
	 */
	public final static void transpose(MatrixY input, MatrixY output) {
	...
	public final boolean equals(MatrixY b, double tolerance) {
	 ...
	 */
	public static boolean invert(MatrixY input, MatrixY output) {
