...
public class MatrixOne {
	...
	/* Copy a matrix. */
	static void copy_matrix(MatrixOne source, MatrixOne destination) {
	...
	static void add_matrix(MatrixOne a, MatrixOne b, MatrixOne c) {
	...
	static void subtract_matrix(MatrixOne a, MatrixOne b, MatrixOne c) {
		assert (a.rows == b.rows);
		assert (a.rows == c.rows);
		assert (a.cols == b.cols);
		assert (a.cols == c.cols);
	...
	static void subtract_from_identity_matrix(MatrixOne a) {
	...
	static void multiply_matrix(MatrixOne a, MatrixOne b, MatrixOne c) {
	 ...
	 */
	static void multiply_by_transpose_matrix(MatrixOne a, MatrixOne b, MatrixOne c) {
		assert (a.cols == b.cols);
		assert (a.rows == c.rows);
	...
	static void transpose_matrix(MatrixOne input, MatrixOne output) {
	...
	static boolean equal_matrix(MatrixOne a, MatrixOne b, double tolerance) {
		assert (a.rows == b.rows);
		assert (a.cols == b.cols);
		for (int i = 0; i < a.rows; ++i) {
			for (int j = 0; j < a.cols; ++j) {
	 ...
	 * the bottleneck.
	 */
	static boolean destructive_invert_matrix(MatrixOne input, MatrixOne output) {
